...
az cosmosdb sql database create `
  --resource-group ${RESOURCE_GROUP} `
  --account-name ${ITEM_SERVICE_COSMOSDB} `
  --name ${ITEM_SERVICE_COSMOSDB_DATABASE} `
  --throughput ${ITEM_SERVICE_COSMOSDB_DATABASE_THROUGHPUT}
az cosmosdb sql container create `
  --resource-group ${RESOURCE_GROUP} `
  --account-name ${ITEM_SERVICE_COSMOSDB} `
  --database-name ${ITEM_SERVICE_COSMOSDB_DATABASE} `
  --name ${ITEM_SERVICE_COSMOSDB_COLLECTION} `
